...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-04-2022 a las 05:49:19
...
CREATE TABLE `estadopedido` (
  ...
  `proceso` enum('en espera','en empaque','en separacion','en facturacion','en ruta','Listo') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `estadopedido` (`id_estado`, `proceso`) VALUES
(1, 'en espera'),
(2, 'en empaque'),
(3, 'en separacion'),
(4, 'en facturacion'),
...
CREATE TABLE `usuario` (
  ...
  `departamento` bigint(11) NOT NULL,
...
(1, 'jaku', 'maku', 11441231, 24, 1009, 'cra12#5213', 'asdas@as.com', 3102552510, 255, 'vendedor'),
(2, 'mia', 'mania', 11440551623, 1, 1, 'cra45#12-50', 'cra@.com', 3102556978, NULL, 'cliente'),
(3, 'rio', 'janeiro', 11440551623, 2, 2, 'cra45#12-50', 'cra@.com', 3102556978, NULL, 'admin');
...
ALTER TABLE `pedido`
  ...
  ADD KEY `PedcliUsu_FK` (`id_cliente`),
  ADD KEY `pedEsta_FK` (`id_estado`);
...
--
ALTER TABLE `municipios`
  MODIFY `id_municipio` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1127;
